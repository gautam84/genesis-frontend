  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98] dark:ring-offset-slate-950",
  {
    variants: {
      variant: {
        ...
        outline: "border-2 border-[var(--border)] bg-white text-slate-900 hover:bg-[var(--surface)] hover:text-white dark:border-slate-600 dark:bg-slate-800 dark:text-white dark:hover:bg-slate-700",
        secondary:
        ...
        ghost: "bg-white text-slate-900 hover:bg-[var(--surface)] hover:text-white dark:border-slate-600 dark:bg-slate-800 dark:text-white dark:hover:bg-slate-700",
